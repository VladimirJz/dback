...
class Servers(models.Model):
    ...
    DBMS_TYPES = [(1, 'MS SQLServer'),(2,'MySQL/MariaDB'),(3, 'PostgreSQL'),(4,'MongoDB')];
...
class DataBases(models.Model):
    ...
    def get_absolute_url(self):       
        return reverse('datatabases_list', args=[str(self.id)])
...
class Tables(models.Model):
    ...
    TableCategory=ForeignKey(TableCategory,on_delete=models.SET_NULL,null=True,default=1)
